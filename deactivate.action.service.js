...
(function() {
  ...
  function deactivateService(
    ...
    function perform(image) {
      var deferred = glance.deactivateImage(image.id);
    ...
    function submit(stepModels) {
      var image = stepModels.deactivateForm;
      ...
      function deactivateImage() {
        return glance.deactivateImage(image).then(onDeactivateImageSuccess, onDeactivateImageFail);
      }
