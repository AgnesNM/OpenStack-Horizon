...
(function () {
  ...
  function glanceAPI(apiService, toastService) {
    ...
    function updateImage(image) {
      return apiService.patch('/api/glance/images/' + image.id + '/', image) //PATCH /v2/images/{image_id}
        .catch(function onError() {
    ...
    function deactivateImage(image) {
      return apiService.post('/api/glance/images/' + image.id + '/actions/deactivate/' + '/', image) //POST  /v2/images/{image_id}/actions/deactivate
        .catch(function onError() {
