...
npm: install_package> python -I -m pip install --force-reinstall --no-deps /home/nduta/horizon/.tox/.tmp/package/16/horizon-25.1.1.dev1-0.editable-py3-none-any.whl
...
up to date, audited 400 packages in 6s
...
(node:7786) [DEP0044] DeprecationWarning: The `util.isArray` API is deprecated. Please use `Array.isArray()` instead.
...
✖ 737 problems (1 error, 736 warnings)

npm: exit 1 (4.20 seconds) /home/nduta/horizon> npm run lint pid=7769
  npm: FAIL code 1 (52.51=setup[9.02]+cmd[33.56,5.72,4.20] seconds)
  evaluation failed :( (52.68 seconds)
